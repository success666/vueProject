<template>
    ...
    <div ref="history" class="history">
        ...
        <el-table :data="tabledata.list" style="width:100%;" class="border-radius">
            <el-table-column prop="areaName" label="反馈日期" width="180">
            </el-table-column>

            <el-table-column prop="schoolName" label="区" width="180">
            </el-table-column>
            ...
            <el-table-column prop="diseaseName" label="运动时长">
            </el-table-column>
...
<style src="./motionFeedbackStatistics.scss" scoped>
